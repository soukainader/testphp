...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- <a class="navbar-brand logo-text page-scroll" href="acceuil.html">Tivo</a> -->

            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="acceuil.html"><img src="images/logo1.png" alt="alternative"></a> 
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="acceuil.html">Accueil</a>
                    </li>
                    <!-- Dropdown Menu -->          
                    <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle page-scroll" href="acceuil.html#video" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Produits</a>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll active" href="http://localhost/testphp/nous-contacter.php">Nous contacter</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-container">
                                <form autocomplete="off" class="gform" role="form" method="post" action="http://localhost/testphp/email.php">
